...
export default function LinkContent({ setShowDocumentsModal }) {
        ...
        <>
            ...
            <section className="px-4 py-10 bg-white">
                <div className="text-center space-y-2 mb-8">
                    <h2 className="text-2xl font-bold text-slate-800">Payment Link</h2>
                    <p className="text-slate-600 text-sm">แค่ส่งลิงก์ ลูกค้าก็จ่ายได้ทันที ไม่ต้องมีหน้าร้าน</p>
                </div>
            ...
            <section className="py-8 px-4 bg-gradient-to-b from-white to-[#EEF2FF] text-center">
                ...
                <div className="grid grid-cols-3 gap-3 my-6">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-xs font-medium text-[#0A47CB]">สร้างลิงก์</p>
                    </div>
                    {/* Step 2 */}
                    <div className="text-center">
                        <div className="relative mx-auto mb-2">
                        ...
                        <p className="text-xs font-medium text-[#0A47CB]">ส่งให้ลูกค้า</p>
                    </div>
                    {/* Step 3 */}
                    <div className="text-center">
                        <div className="relative mx-auto mb-2">
                        ...
                        <p className="text-xs font-medium text-[#0A47CB]">รับเงิน!</p>
                    </div>
                </div>
                <button
                    className="bg-white border border-slate-200 rounded-full px-6 py-3 text-sm font-medium cursor-pointer inline-flex items-center gap-2 shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-colors hover:bg-gray-50"
                    onClick={() => setShowDocumentsModal && setShowDocumentsModal(true)}
                >
                    เอกสารการสมัคร <span className="w-6 h-6 bg-[#4064FF] text-white rounded-full inline-flex items-center justify-center text-base">+</span>
                </button>
            </section>

            {/* CTA Section */}
            <section className="py-8 px-4 bg-gradient-to-br from-[#0A47CB] to-[#4064FF] text-white text-center">
                <h2 className="text-xl font-bold mb-2">สนใจสมัคร Payment Link</h2>
                <p className="text-sm opacity-90 mb-6">เริ่มต้นรับชำระเงินออนไลน์ได้ทันที</p>
                <button className="bg-white text-[#0A47CB] border-none rounded-full font-semibold cursor-pointer transition-colors hover:bg-gray-100 px-8 py-3 text-base shadow-lg">
                    สมัครเลย
                </button>
            </section>
            ...
            <section className="py-8 px-4 bg-white">
                ...
                <div className="flex flex-col gap-4">
                    <div className="bg-[#EEF2FF] rounded-2xl p-5">
                        ...
                        <p className="text-sm text-slate-600">กดลิงก์เปิดในเบราว์เซอร์ พร้อมจ่ายได้เลย ไม่ต้องสมัครหรือโหลดอะไรเพิ่ม</p>
                    </div>
                    <div className="bg-[#EEF2FF] rounded-2xl p-5">
                        <h3 className="font-semibold text-[#0A47CB] mb-2">รองรับผ่อนชำระ 0%</h3>
                        <p className="text-sm text-slate-600">ลูกค้าสามารถเลือกผ่อนชำระ 0% สูงสุด 10 เดือน กับบัตรเครดิตที่ร่วมรายการ</p>
                    </div>
                    <div className="bg-[#EEF2FF] rounded-2xl p-5">
                        <h3 className="font-semibold text-[#0A47CB] mb-2">แจ้งเตือนทันทีเมื่อรับเงินสำเร็จ</h3>
                        <p className="text-sm text-slate-600">ได้รับแจ้งเตือนผ่าน LINE และอีเมลทันทีเมื่อลูกค้าชำระเงินเรียบร้อย</p>
                    </div>
                </div>
            </section>
